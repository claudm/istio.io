...
1. **remote**: used for configuring remote clusters of a
    ...
    [shared control plane](/pt-br/docs/setup/install/multicluster/shared/) configuration.
...
To further [customize Istio and install addons](/pt-br/docs/setup/install/istioctl/#customizing-the-configuration), you can add one or more `--set <key>=<value>` options in the
`istioctl install` command that you use when installing Istio.
Refer to [integration](/pt-br/docs/ops/integrations) for more details.
