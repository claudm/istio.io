...
* The [Collecting Metrics](/pt-br/docs/tasks/observability/mixer/metrics/collecting-metrics/) task describes how to configure metrics for services in a mesh.
...
1.  Redefine your `VirtualService` for _edition.cnn.com_:
    ...
    (/pt-br/docs/tasks/traffic-management/egress/egress-gateway/#additional-security-considerations)). You don't want any tampering
    with your policies.
